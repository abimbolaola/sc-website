...
<html lang="en">
  <head>
	...
	<title>Order History | Social Care | Social Media Agency</title>
	<meta name="description" content=""/>
	<meta name="keywords" content=""/>
	<meta name="robots" content="index, follow">
<link href="https://www.mediamister.com/order-history" rel="canonical">
...
<li class="breadcrumb-item active" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">Order History</span><meta itemprop="position" content="1" /></li>
</ol>
</div>
  </div>
...
<div class="container">
<div class="row">
<div class="col-sm-12 mb-5 up-menu-overflow">
<ul class="up-menu">
<li><a href="dashboard.php" ><img src="images/user-panel/up-menu-1.png" alt=""/> Dashboard</a></li>
<li><a href="order-history.php" class="up_active"><img src="images/user-panel/up-menu-2.png" alt=""/> Order History</a></li>
<li><a href="account-details.php" ><img src="images/user-panel/up-menu-3.png" alt=""/> Account Details</a></li>
<li><a href="billing-details.php" ><img src="images/user-panel/up-menu-4.png" alt=""/> Billing Details</a></li>
<li><a href="change-password.php" ><img src="images/user-panel/up-menu-5.png" alt=""/> Change Password</a></li>
</ul>
</div>
<h1 class="main-title text-center">Order History</h1>
<div class="table-responsive-sm">
<div class="orh-fileter-box">
<div class="col">
<label>Order Id</label>
<input type="text" id="orderid" placeholder="Order ID" onkeyup="searchFilter()" class="form-control" />
</div>
<div class="col">
<label>Payment Status</label>

<select id="payment_status" onchange="searchFilter()" class="form-control">
	<option value="">Payment Status</option>
	<option value="Processing">Waiting for payment</option>
...
<select id="payment_type" onchange="searchFilter()" class="form-control float-left">
<option value="">Payment Type</option>
<option value="Bitcoin">Bitcoin</option></select>
</div>
<div class="col">
<label>Sort By</label>
<select id="sortBy" onchange="searchFilter()" class="form-control float-left ml-2">
...
<select name="per_page" id="per_page" class="form-control float-left required ml-2" onchange="searchFilter()">
...
<div class="orh-filter-btn ms-auto">
<label>&nbsp;</label><br/>
<a href="/order-history" class="btn btn-filter"><i class="fas fa-undo-alt"></i> Reset</a></p>
</div>
</div>
</div>
<div id="posts_content">
<div class="loading-overlay" style="display:none;"><div class="overlay-content"><i class="fa fa-spinner fa-spin"></i> Loading please wait.....</div></div>
<div class="order-history-box">
<div class="orh-top">
<div class="orh-top-details">
<h3>Order ID</h3>
<p>CCM000673409</p>
</div>
<div class="orh-top-details">
...
<p class="inprogress">Waiting For Payment
</div>
<div class="orh-top-details">
<h3>Total</h3>
<p>$4.75</p>
</div>
<div class="orh-top-links ms-auto">
<a href="view-order-details?id=730627" class="btn btn-primary"><i class="fas fa-eye"></i> View Order Details</a>


<a href="https://www.mediamister.com/view-cart-abandoned?sesid=qmppeairoit6k8o5bsm79svils&utm_source=userpanel&utm_medium=makepayment_button&utm_campaign=make_payment&utm_id=makepayment" class="btn btn-warning"><i class="far fa-credit-card"></i> Make Payment</a>

</div>
</div>

<div class="orh-bottom">
<div class="table-responsive-sm">
<table class="table orh-table white-bg">
  ...
  <tbody>
  	...
  	<ul style="list-style-type:none;padding-left:0;margin-bottom:0;" class="write_review_main">    <tr>
      <td class="product-details"><img src="images/service-icons/4.webp" width="64px" height="64px" alt=""/> 				
	 100 Instagram Followers 
</td>
<td class="prod-status"><span class="nostatus">-- </span></td>
      <td class="prod-review">
...
<div class="modal fade up_review_box" id="reviewpopup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-end" id="exampleModalLabel">Write Your Review</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i class="fas fa-times"></i></button>
      </div>
      <div class="modal-body">
		<form id="comment_form" name="usercomment" class="comment_form up_review" method="post" autocomplete="off">
<div class="response"></div>
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<label>Your Name <span class="text-danger">*</span></label>
						<input type="text" id="name" name="name" class="form-control required" placeholder="@name" value="Abimbola" />
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<label>Your Email <span class="text-danger">*</span></label>
						<input type="text" id="email" name="email" class="form-control required" readonly placeholder="@email address" value="abimbola12015@gmail.com" />
					</div>
				</div>
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<textarea id="comment" name="comment" class="form-control required" placeholder="@comments"></textarea>
					</div>
				</div>
		
			<div class="col-md-12 ratingdiv">
			<div class="form-group">
				...
				<div class="col-md-12">
					...
					<input type="hidden" id="url_path" name="url_path" />
						<button type="submit" class="form-control btn btn-primary">Post Your Review <i class="fa fa-spin fa-spinner comment_loader" style="display:none;"></i></button>
					</div>
				</div>
		...
		(function($,W,D)
		{
							...
							if(rating_check != '0') {
								...
								$.post('ajax-user-comments', {
									...
									setTimeout(function() {
										...
										$(".response").hide();
										$('.reviewed_res_'+sid).html('(Reviewed)');										
									}, 2000);
			...
			function searchFilter(page_num) {
				...
				$.ajax({
					type: 'POST',
					url: 'getData',
					data:'page='+page_num+'&orderid='+orderid+'&sortBy='+sortBy+'&payment_status='+payment_status+'&service_status='+service_status+'&payment_type='+payment_type+'&per_page='+per_page,
					beforeSend: function () {
					...
					success: function (html) {
						...
						$('.loading-overlay').fadeOut("slow");
						 $('html, body').animate({
         scrollTop: $("#posts_content").offset().top
  }, 10); 
					}
				});
			}
