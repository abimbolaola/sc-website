...
<html lang="en">
  <head>
	...
	<title>Account Details | Social Care | Social Media Agency</title>
	<meta name="description" content=""/>
	<meta name="keywords" content=""/>
	<meta name="robots" content="index, follow">
<link href="https://www.mediamister.com/account-details" rel="canonical">
...
<li class="breadcrumb-item active" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">Account Details</span><meta itemprop="position" content="1" /></li>
...
<li><a href="account-details.php" class="up_active"><img src="images/user-panel/up-menu-3.png" alt=""/> Account Details</a></li>
...
<h1 class="main-title text-center">Account Details</h1>

<div class="order-history-box vord-payment-info">

<form id="account-form" name="account" method="post" autocomplete="off">
<div class="result"></div>
<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="form-group">
							<label>First Name <span class="mandatory">*</span> </label>
							<input type="text" name="first_name" value="Abimbola" class="form-control required valid" placeholder="First Name" />
						</div>
					</div>
					<div class="col-lg-4 col-md-6">
						<div class="form-group">
								<label>Last Name <span class="mandatory">*</span></label>
							<input type="text" name="last_name" value="Josiah" class="form-control required valid" placeholder="Last Name" />
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6">
						<div class="form-group">
							...
							<input type="email" name="email" value="abimbola12015@gmail.com" readonly class="form-control required valid" placeholder="Email Address" />
						</div>
					</div>
					<div class="col-lg-4 col-md-6">
						<div class="form-group">
								<label>Phone Number</label>
							<input type="text" name="company_name" id="company_name" value="+234 8135974602" class="form-control" placeholder="Phone Number" />
						</div>
					</div>
					<div class="col-lg-4 col-md-6">
						<div class="form-group">
								<label>Password <span class="mandatory">*</span></label>
							<input type="password" name="upwd" id="upwd" class="form-control required" placeholder="Password" />
							<p class="note-box mt-1"><small>Please enter your password to update account details.</small></p>
						</div>
					</div>
				...
				<div class="col-sm-12">
						...
						<div class="col-lg-4 col-md-12 mx-auto">
							<div class="form-group">
								...
								<button class="form-control btn signin-btn" name="account"  type="submit"><i class="fas fa-file-alt"></i> UPDATE YOUR ACCOUNT <i class="fa fa-spinner fa-spin loader" style="display:none;"></i></button>
				...
				setupFormValidation: function()
				{
					$("#account-form").validate({
						...
						submitHandler: function(form) {
							...
							$.ajax({
								type: "POST",
								url: "ajax-userlog-form?act=update_account",
								data: $(form).serialize(),
