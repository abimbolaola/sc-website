...
<html lang="en">
  <head>
	...
	<title>Dashboard | Social Care | Social Media Agency</title>
	<meta name="description" content=""/>
	<meta name="keywords" content=""/>
	<meta name="robots" content="index, follow">
<link href="https://www.mediamister.com/dashboard" rel="canonical">
...
<li class="breadcrumb-item active" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">Dashboard</span><meta itemprop="position" content="1" /></li>
</ol>
</div>
  </div>
...
<ul class="up-menu">
<li><a href="dashboard.php" class="up_active"><img src="images/user-panel/up-menu-1.png" alt=""/> Dashboard</a></li>
<li><a href="order-history.php" ><img src="images/user-panel/up-menu-2.png" alt=""/> Order History</a></li>
...
<h1 class="main-title text-center">Quick Summary</h1>
<div class="up-menu-overflow">
<ul class="up-statistics">
<li class="totorder-stat">
<span>1</span><br/>Total Orders</li>
<li class="paysuc-stat">
<span>0</span><br/>Order(s) Placed</li>
<li class="waitpay-stat">
<span>1</span><br/>Waiting For Payment</li>
</ul>
</div>
<h2 class="main-title text-center mt-md-5">Recent Order(s)</h2>
...
<a href="https://www.mediamister.com/view-cart-abandoned.php?sesid=qmppeairoit6k8o5bsm79svils&utm_source=userpanel&utm_medium=makepayment_button&utm_campaign=make_payment&utm_id=makepayment" class="btn btn-warning"><i class="far fa-credit-card"></i> Make Payment</a>
...
<a href="order-history.php" class="btn btn-outline-primary"><i class="fas fa-eye"></i> View more orders</a>
</div>
