...
<html lang="en">
  <head>
	...
	<title>Privacy Policy | Social Care | Social Media Agency</title>
	<meta name="description" content="We value our customer's privacy & will not share it with any third parties. For more details about our privacy policy, read the content given on this page." />
	<meta name="keywords" content="privacy policy, Social Care privacy policy, mediamister privacy policy, privacy policy Social Care"/>
	
	<meta name="robots" content="index, follow">
<link href="https://www.mediamister.com/policy" rel="canonical">
...
setTimeout(function(){
  ...
  gtag('config', 'G-HYMMDZ2Y3D');
	...
	<meta property="og:title" content="Privacy Policy | Social Care | Social Media Agency" />
	<meta property="og:description" content="We value our customer's privacy & will not share it with any third parties. For more details about our privacy policy, read the content given on this page."/>
	<meta property="og:url" content="https://www.mediamister.com/policy" />
	<meta property="og:site_name" content="Social Care" />
	<meta property="og:image" content="https://www.mediamister.com/images/og/policy.jpg" />
	<meta name="revised" content="Wednesday, December 15, 2021, 07:28 AM" />
	<meta name="copyright" content="Social Care">
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:description" content="We value our customer's privacy & will not share it with any third parties. For more details about our privacy policy, read the content given on this page." />
	<meta name="twitter:title" content="Privacy Policy | Social Care | Social Media Agency" />
	<meta name="twitter:site" content="@MediaMr" />
	<meta name="twitter:image" content="https://www.mediamister.com/images/og/policy.jpg" />
	<meta name="twitter:creator" content="@MediaMr" />
...
<li class="ui-menu-item"><a href="https://www.mediamister.com/buy-youtube-views">Buy YouTube Views</a></li>
 ...
 <li class="ui-menu-item"><a href="https://www.mediamister.com/buy-linkedin-followers">Buy LinkedIn Followers</a></li>
   ...
   <a href="https://www.mediamister.com/view-cart.php"><img src="https://www.mediamister.com/images/cart-icon.webp" width="50px" height="40px"  alt="view cart"/> <span class="carttext">Cart</span> (<span class="result_cart_cnt">0</span>)</a>

<a href="https://www.mediamister.com/login"><img src="https://www.mediamister.com/images/login-icon.webp" width="50px" height="40px"  alt="login"/> <span>Login</span></a>
...
<li class="breadcrumb-item active" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">Privacy Policy</span><meta itemprop="position" content="1" /></li>
</ol>
</div>
  </div>
...
<h1 class="main-title text-center"><i class="far fa-newspaper"></i> Privacy Policy</h1>
</div>
</div>
<div class="content-area">
<p>Social Care works extremely hard to safeguard the private information collected from customers and users of the Social Care website. We never sell or distribute private information to third parties for marketing or promotional purposes of any kind,</p>
<p>All personal information collected by Social Care is used strictly for quality purposes, helping us improve the services we provide. Customers have the right to request the correction or removal of any of their personal information held by Social Care – contact a member of the team at <a href="mailto:info@mediamister" target="_blank">info@mediamister.com</a>.</p>
		<p>Please be advised that the conditions laid out within this privacy policy are subject to change at any time and without notice. It is therefore the responsibility of the customer to regularly consult this document, in order to ensure their ongoing compliance with and understanding of the specified terms.</p>
		<p>Upon accessing the Social Care website or any of the services provided by the company, the customer expressly consents to abide by the terms and conditions laid out in this privacy policy. If you are unable or unwilling to comply with all terms and conditions laid out by Social Care, you are forbidden from accessing the company’s website.</p>
			<h2>Information We Request</h2>
		<p>In order to access the services provided by Social Care, the customer is required to submit personal information including their full name, contact details, company information, payment information and other related data as specified by the company.</p>
		<p>The customer expressly consents to provide Social Care with 100% complete and accurate information, ensuring any changes to their personal information are brought to the attention of the company as quickly as possible.</p>
		<p>Customers are not obliged to provide the company with any personal information, though refusal to provide the required data may result in the inability to access the services provided by Social Care. The customer also accepts that Social Care may periodically use their personal information to contact them regarding special offers and promotion, or for our own market analysis and research.</p>
		<h2>Secure Information</h2>
		<p>At Social Care, we work hard to ensure our customers and our business are protected from the unauthorized access, destruction, disclosure or alteration of the private data we hold.  All transactions are safeguarded by cutting-edge electronic and physical monitoring procedures and security measures for maximum peace of mind.</p>
		<p>Social Care uses the latest SSL (Secure Sockets Layer) encryption technology to encrypt our website and checkout process, while continuously reviewing the effectiveness of our physical and virtual safety protocols.  Access to our networks and information databases is restricted exclusively to Social Care employees - each of whom is contractually obliged to uphold the highest possible safety and security standards at all times.</p>
		<h2>Cookie Use</h2>
		<p>Cookies are small files placed on the computers of Internet users upon accessing websites. Cookies store important information regarding personal preferences, such as preferred languages, product and service interests, browsers/devices used to access the website and so on. Social Care uses cookies to collect non-personal-identifiable information purely for quality purposes.</p>
		<p>If you would prefer not to allow cookies to be stored on your computer, please consult your browser’s user guidelines for instructions on how to remove and block cookies.</p>
			<h2>Third-Party Links</h2>
		<p>All third-party links provided by Social Care are to be interpreted as suggestions only and do not constitute recommendations or assurances of any kind from the company. Every customer uses the third-party links provided by Social Care entirely at their own risk, bound by the privacy policies and all terms and conditions of the third-party service providers upon clicking the respective links. We accept no liability for any consequences that may arise due to the use of any links featured on the Social Care website.</p>
<h2>More Information</h2>
<p>Social Care does not send unsolicited emails, nor do we distribute e-mail addresses to third parties to enable them to contact you without your permission.</p>
<p>The Social Care website can be accessed without the need to disclose any personal information.  However, it is necessary to provide certain types of personal data to register with Social Care, in order to subsequently make use of the products and services we provide.</p>
<p>It is the sole responsibility of the customer to ensure that the personal information they provide is accurate, complete and up to date.</p>
<p>The IP addresses of all registered customers and website visitors are collected, stored and aggregated, in order to enable Social Care to better understand our main demographics.  None of this information is personally identifiable.</p>
<p>In addition, Social Care never knowingly collects any personal information or data of any kind from minors. </p>
<p>At all times, we make every effort to safeguard our customers and their private information from unauthorized access and improper use.  However, it is not possible for any virtual of physical safety measure to provide 100% protection from all types of attacks or accidental eventualities. Social Care therefore accepts no liability or responsibility for any consequences that may occur in the event of a data breach or security incident beyond the direct control of our company.</p>
<p>You therefore agree to hold us harmless and to indemnify us against any damages , loss, injuries, fees, costs and claims of any nature, regarding such security breaches.</p>

		<h2>Contact Social Care</h2>
		<p>If you have any questions or issues regarding any aspect of this privacy policy, please contact a member of the Social Care team immediately at <a href="mailto:info@mediamister" target="_blank">info@mediamister.com</a>.</p>
...
<div class="section_type_1 excellent-support">
<div class="container">
<div class="row">
<h2 class="text-center">Excellent Customer Support</h2>
 </div>
 <div class="row mt-lg-5">
<div class="col-lg-6 col-md-6 col-sm-12">
<img src="images/customer-support.webp" loading="lazy" width="665px" height="583px" class="img-fluid cus-sup" alt="customer support"/>
</div>
<div class="col-lg-6 col-md-6 col-sm-12 mt-lg-5">
<p>You can find all the answers to all of your questions about our social media services in a fast way. Live and fast support for everyone!</p>
<div class="live_support">
<i class="chat"></i> <a href="https://direct.lc.chat/12827958/" target="_blank">Live Chat Support</a>
</div>
<div class="live_support">
<i class="email"></i> <span>Email Support</span><br/>
<a href="mailto:info@mediamister.com">info@mediamister.com</a>
</div>
 </div>
 </div>
<div class="row mt-5">
...
<i class="stat1"></i>
<h2 class="sub-title"><span class="countfect" data-num="76320"></span> + </h2><br/>
<p>Happy Customers</p>
</div>
  <div class="col-sm-4 mt-lg-5">
<i class="stat2"></i>
<h2 class="sub-title"><span class="countfect" data-num="105898"></span> +</h2><br/>
<p>Orders Delivered</p>
</div>
<div class="col-sm-4 mt-lg-5">
<i class="stat3"></i>
<h2 class="sub-title"><span class="countfect" data-num="192"></span> +</h2><br/>
...
<p class="foot-social"><a href="https://www.facebook.com/mediamister" rel="noreferrer" target="_blank"><i class="fab fa-facebook-square"></i> Facebook</a> <a href="https://twitter.com/MediaMister_MM" rel="noreferrer" target="_blank"><i class="fab fa-twitter-square"></i> Twitter</a> <a href="https://www.pinterest.com/mediamister/" rel="noreferrer" target="_blank"><i class="fab fa-pinterest-square"></i> Pinterest</a></p>
 ...
 <div class="profile-icon"><i class="fas fa-user"></i></div> <div class="profile-msg">Welcome</div>
