...
<html lang="en">
 ...
 <title>Login | Social Care</title>
 <meta name="description" content="Login in Social Care and increase your social media presence."/>
    <meta name="keywords" content=""/>
	<meta name="robots" content="index, follow">
<link href="https://www.mediamister.com/login" rel="canonical">
...
<li class="breadcrumb-item active" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">Login</span><meta itemprop="position" content="1" /></li>
</ol>
</div>
  </div>
...
<h1 class="main-title text-center"><i class="far fa-newspaper"></i> Sign In/Sign Up</h1>
</div>
</div>
...
<div class="signinimg">
<img src="images/signin-img.webp" width="780px" height="992px" class="img-fluid" alt="sign in"/>
</div>
<div class="signupimg" style="display:none;">
<img src="images/signup-img.webp" width="780px" height="992px" class="img-fluid" alt="sign up"/>
</div>
</div>
<div class="col-md-7 col-sm-12">
<div class="signinform-box">

							
							<div class="response_msg"></div>
							<div class="suc_msg success-msg" style="display:none;"></div>
							<div class="err_msg error-msg" style="display:none;"></div>
							<div class="info_msg success-msg" style="display:none;"></div>
							<div class="warning_msg error-msg" style="display:none;"></div>

<div class="forgotpassword" style="display:none;">
<form id="forgot-form" name="forgot-pwd" method="post" autocomplete="off">
 <h2 class="sub-title-2 text-center">Forgot your password?</h2>
 <p class="text-center">Don't worry. Please enter your email address to reset your password.</p>

					<div class="col-sm-12">
						<div class="form-group">
							<label>Email Address <span class="mandatory">*</span> </label>
							<input type="text" name="rec_email" class="form-control required" placeholder="Email Address" />
						</div>
					</div>
						...
						<div class="col-sm-12 mt-2">
							<div class="form-group">
								...
								<button class="form-control btn signin-btn" type="submit"><i class="fas fa-key"></i> RESET PASSWORD</button>
							...
							<div class="col-sm-12">
							<div class="form-group">
							<div class="text-center">Remember your password? <span class="signlink signinform">Sign In</span></div>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    <a class="nav-link active" id="signin-tab" data-bs-toggle="tab" href="#signin" role="tab" aria-controls="signup" aria-selected="true">Sign In</a>
  </li>
  <li class="nav-item" role="presentation">
...
<div class="tab-content" id="myTabContent">
  ...
  <div class="row">
 <form id="login-form" name="login" method="post" autocomplete="off">

					<div class="col-sm-12">
						<div class="form-group">
							<label>Email Address <span class="mandatory">*</span> </label>
								<input type="text" name="log_email" id="log_email" class="form-control required" placeholder="Email Address" />
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
								<label>Password <span class="mandatory">*</span></label>
							<input type="password" name="log_pwd" class="form-control required" placeholder="Password" />
							<span class="showpwd"><i class="far fa-eye"></i><i class="far fa-eye-slash"></i></span>
						</div>
					</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<button class="form-control btn signin-btn" type="submit"><i class="fas fa-sign-in-alt"></i> SIGN IN</button>
							...
							<div class="col-sm-12">
							<div class="form-group">
							<span class="float-start signlink for-pwd">Forgot password?</span>
							<div class="float-end">Don't have an account? <span class="signlink signupform">Sign Up</span></div>
  ...
  <div class="row">
<form id="register-form" name="register" method="post" autocomplete="off">
					<div class="col-sm-12">
						<div class="form-group">
				...
				<div class="col-sm-12">
					...
					<label>Phone Number</label>
										<input type="text" name="company_name" id="company_name" class="form-control" placeholder="Phone Number" />
									</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
								<label>Password <span class="mandatory">*</span></label>
							<input type="password" name="upwd" id="upwd" minlength="6" maxlength="12" class="form-control required" placeholder="Password" />
							<span class="showpwd"><i class="far fa-eye"></i><i class="far fa-eye-slash"></i></span>
						</div>
					</div>
					...
					<div class="col-sm-12">
						<div class="form-group">
							...
							<input type="password" name="cpwd" minlength="6" maxlength="12" class="form-control cpwd required" placeholder="Confirm Password" />
							<span class="showpwd"><i class="far fa-eye"></i><i class="far fa-eye-slash"></i></span>
						</div>
					</div>
					...
					<div class="col-sm-12">
							<div class="form-group check-subnews">
									...
									<input type="checkbox" class="form-check-input" id="sub-news" checked>
						...
						<div class="col-sm-12">
							<div class="form-group check-agree">
									...
									<label class="form-check-label" for="agree"><small>By clicking this button, you agree to our <a href="https://www.mediamister.com/terms" target="_blank">Terms of Service</a> and <a href="https://www.mediamister.com/policy" target="_blank">Privacy Policy</a>.</small></label>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<button class="form-control btn signin-btn" type="submit"><i class="fas fa-file-alt"></i> SIGN UP <i class="fa fa-spinner fa-spin reg_loader" style="display:none;"></i></button>
							...
							<div class="col-sm-12">
							<div class="form-group">
							<div class="text-center">Already have an account? <span class="signlink signinform">Sign In</span></div>
...
$(document).ready(function(){
  ...
  $("#signin-tab,.signinform").click(function(){
		$("input").removeClass('error');
		$("label.error").hide();
	  
		$(".signinimg").show();
		$(".signupimg").hide();
		$(".success-msg,.error-msg").hide();
		//$('#login-form')[0].reset();
  ...
  $("#signup-tab,.signupform").click(function(){
    $(".signinimg").hide();
	$(".signupimg").show();
	$(".success-msg,.error-msg").hide();
	//$('#login-form')[0].reset();
...
$('.warning_msg').hide();
	...
	$("label.error").hide();
$('html, body').animate({
         scrollTop: $("#forgot-form").offset().top
  }, 100); 
});
...
<script>
				...
				setupFormValidation: function()
				{
					$("#login-form").validate({
						...
						submitHandler: function(form) {
							...
							$.ajax({
								type: "POST",
								url: "ajax-userlog-form?act=user_login",
								data: $(form).serialize(),
								beforeSend: function() {
								...
								success: function (response) {
									...
									if(response=='1'){
										...
										$('.login_loader').hide();
										$('.warning_msg').show();
										$('.warning_msg').html("<i class='fa fa-exclamation-triangle'></i> The email address or password you entered is incorrect.");
										$('#login-form')[0].reset();
									}
									else if(response=='2'){
										$('.login_loader').hide();
										$('.info_msg').show();
										$('.info_msg').html("<i class='fa fa-info-circle'></i> You must verify your email address to continue. <span id='resend_verify_email'>Resend verification email</span>");
										...
										$("#resend_verify_email").click(function(){
											...
											$.ajax({
												type: "POST",
												url: "ajax-userlog-form.php?act=resend_verify_email",
												data : {email: email},
												success: function (data) {
													$('.info_msg').show();
													$('.info_msg').html("<i class='fa fa-info-circle'></i> You must verify your email address to continue.");
													$('#login-form')[0].reset();
												}
											});
										});
        ...
        email: {
            ...
            remote: "Email already in use!"
						...
						submitHandler: function(form) {
							...
							$.ajax({
								type: "POST",
								url: "ajax-userlog-form?act=user_register",
								data: $(form).serialize(),
								success: function (response) {
									$('.reg_loader').hide();
									$('.response_msg').show();
					...
					$("#forgot-form").validate({
						...
						submitHandler: function(form) {
							...
							$.ajax({
								type: "POST",
								url: "ajax-userlog-form?act=user_pwd_recovery",
								data: $(form).serialize(),
								success: function (response) {
									$('.forgot_loader').hide();
									$('.info_msg').hide();
									...
									if(response=='1'){
										$('.info_msg').show();
										$('.info_msg').html("<i class='fas fa-check-circle'></i> We have sent password reset link to your registered email address.");
										$('#forgot-form')[0].reset();
									}
									else{
										$('.warning_msg').show();
										$('.warning_msg').html("<i class='fa fa-exclamation-triangle'></i> Email address not registered with us.");
									}
								}
							});
						}
	...
	<script>
	$( ".showpwd .fa-eye" ).click(function() {
		//alert('1');
	//$(this).sibling().prop("type", "text");
	var showpwd=$(this).parent().parent().find('input').prop("type",'text');
	$(this).hide();
	$(this).parent().parent().find('.fa-eye-slash').show();
	});
	$( ".showpwd .fa-eye-slash" ).click(function() {
var showpwd=$(this).parent().parent().find('input').prop("type",'password');
	$(this).hide();
	$(this).parent().parent().find('.fa-eye').show();
	});
</script>
	<script src="js/intlTelInput.js"></script>
	<script>
		$("#company_name").intlTelInput();
	</script>
